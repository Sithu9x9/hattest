...
@section('content')
    ...
    @else
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 form-group">
                        ...
                        <p class="danger">{{ $errors->update->first('current_password') }}</p>
                        <p class="danger">{{ $errors->success->first('current_password') }}</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 form-group">
                        ...
                        <p class="danger">{{ $errors->update->first('new_password') }}</p>
                    </div>
                </div>
        ...
        {!! Form::submit(trans('admin.button.save'), ['class' => 'btn btn-danger']) !!}
        {!! Form::close() !!}
    @endif
@stop
