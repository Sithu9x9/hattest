...
{!! Form::open(['method' => 'PUT', 'route' => ['admin.act-post.update',$act_post->id],'id'=>'EditForm','files' => 'true']) !!}
<div class="box  box-primary">
    ...
    <div class="box-body">
        <div class="row">
            ...
            @if(count($act_post_images) > 0)
                <div class="form-group col-xs-12">
                    <a href="{{route('admin.allimage.destroy',$act_post->id)}}" class="btn btn-danger btn-flat btnalldelete"><i class="fa fa-trash"></i> Delete All Old Images</a>
                </div>                
                <div class="col-xs-12 form-group">
                                ...
                                <div class="box box-primary">
                                    <div class="box-body">
                                        ...
                                        <div class="col-xs-4 text-center" style="padding:45px">                                            
                                            <a href="{{route('admin.image.destroy', $image->id)}}" class="btn btn-xs btn-danger btn-flat btndelete"><i class="fa fa-trash" style="font-size: 25px"></i></a>                                            
                                        </div>
                                    </div><!-- /.box-body -->
                                </div><!-- /.box -->
                            </div>
                ...
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('title', old('title',$act_post->title), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="danger">{{ $errors->update->first('title') }}</p>
                </div>
                <div class="col-xs-12 form-group">
                    {!! Form::label('des', 'Description ', ['class' => 'control-label']) !!}
                    {!! Form::textarea('des', old('des',$act_post->des), ['class' => 'form-control', 'placeholder' => '']) !!}
...
<script>
    $(document).ready(function() {
        ...
        $('#fine-uploader-manual-trigger').fineUploader({
            ...
            request: {
                endpoint: "{{route('update-upload-files',$act_post->id)}}",
                customHeaders: {
